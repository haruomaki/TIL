...
tags:
  ...
  - codeberg
private: false
updated_at: '2025-12-04T00:18:48+09:00'
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/3551504/916fd0d8-9307-406c-b245-64afc9fccdc3.png)

- **「リモートGitリポジトリのURL」にGitHub側のリポジトリ**(`git@`や`ssh://`から始まるURL)
- **「SSH認証を使用する」にチェックを入れる**

以上の2点だけ設定して、「プッシュミラーを追加」を押せばCodeberg側の設定は完了です。
...
Codebergのリポジトリ内容を定期的にプッシュすることで、GitHub上にミラーを作成することができました。
参考にしていただければ幸いです。
